 ...
 */
public abstract class Hilt_ToDoKaListDetailsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ToDoKaListDetailsFragment() {
    super();
  }

  Hilt_ToDoKaListDetailsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ToDoKaListDetailsFragment_GeneratedInjector) this.generatedComponent()).injectToDoKaListDetailsFragment(UnsafeCasts.<ToDoKaListDetailsFragment>unsafeCast(this));
    }
  }
