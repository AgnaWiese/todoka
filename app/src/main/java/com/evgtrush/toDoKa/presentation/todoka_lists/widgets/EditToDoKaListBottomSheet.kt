...
class EditToDoKaListBottomSheet(
    private val toDoKaList: ToDoKaList,
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with(binding) {
            ...
            itemDelete.setOnClickListener {
                viewModel.removeToDoKaList(toDoKaList)
                dismiss()
            }
        }
    }
    ...
    private fun showRenameDialog() {
        ...
        val dialog = MaterialAlertDialogBuilder(requireContext())
            ...
            .setPositiveButton(R.string.item_rename) { dialog, _ ->
                viewModel.renameToDoKaList(toDoKaList.copy(name = textField.text.toString()))
                dialog.dismiss()
            }
